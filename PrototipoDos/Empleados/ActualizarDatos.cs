...
namespace PrototipoDos.Empleados
{
    public partial class ActualizarDatos : Form
    {
        ...
        public ActualizarDatos(TallerDbContext context)
        {
            InitializeComponent();
            _context = context;
            ...
            txtBuscar.KeyPress += txtBuscar_keyPrees;
            ...
            txtCorreoEletronico.Validating += txtCorreoEletrinico_Validating;
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                var empleado = _dataAccessLeyer.BuscarEmpleadoDos(BuscarTexto);

                if (empleado != null)
                {

                    CargarDatosEnTextBox(empleado);
                }
                else
                {
        ...
        private void CargarDatosEnTextBox(GestionPersonalEmpleado empleado)
        {
            txtBuscar.Text = empleado.EmpleadoId.ToString();
            txtNombre.Text = empleado.Nombre;
            txtApellidoPaterno.Text = empleado.ApellidoPaterno;
            txtApellidoMaterno.Text = empleado.ApellidoMaterno;
            cmbSexo.Text = empleado.Sexo;
            txtCorreoEletronico.Text = empleado.CorreoEletronico;
            txtNumero.Text = empleado.NumeroCelular;
        ...
        private void txtBuscar_keyPrees(object sender, KeyPressEventArgs e)
        {
            LongitudCarateres(sender, e, 40);
        }
        ...
        private void txtCorreoEletrinico_Validating(object sender, System.ComponentModel.CancelEventArgs e)
        {
